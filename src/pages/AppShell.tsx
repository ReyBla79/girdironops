...
const NAV_ITEMS = [
  ...
  { to: '/app/budget', icon: Wallet, label: 'Budget', flag: 'budget_core' },
  { to: '/app/forecast', icon: Calendar, label: 'Forecast', flag: 'budget_core' },
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="p-3 border-t border-sidebar-border">
            <button
              ...
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold bg-destructive/15 text-destructive hover:bg-destructive hover:text-destructive-foreground w-full transition-all border border-destructive/40"
            >
